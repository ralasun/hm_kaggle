...
def create_loggers(exp_root):
    ...
    val_loggers = [
        MetricGraphPrinter(writer, key='MAP@12', graph_name='MAP@12', group_name='Validation'),
        RecentModelLogger(model_checkpoint),
        BestModelLogger(model_checkpoint, metric_key='MAP@12')
    ]
